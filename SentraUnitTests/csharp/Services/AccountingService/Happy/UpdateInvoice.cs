...
public class AccountingServiceTests
{
    ...
    [Test]
    public void UpdateInvoice_WithValidInputs_ReturnsUpdatedInvoiceViewModel()
    {
        // Arrange
    ...
    public void UpdateInvoice_WithEmptyLineItems_ClearsExistingLineItems()
    {
        ...
        var invoice = new Invoice
        {
            ...
            LineItems = new List<InvoiceLineItem>
            {
                new InvoiceLineItem { Id = Guid.NewGuid(), Description = "Item 1", Quantity = 2, UnitPrice = 10 }
            }
        };
