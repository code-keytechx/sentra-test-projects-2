...
public class InvoiceServiceTests
{
    ...
    [Test]
    public async Task GetInvoiceSummaries_ThrowsArgumentNullException_WhenListArgsIsNull()
    {
        // Arrange
    ...
    [Test]
    public async Task GetInvoiceSummaries_ThrowsArgumentException_WhenPageSizeIsZero()
    {
        // Arrange
    ...
    [Test]
    public async Task GetInvoiceSummaries_ThrowsArgumentException_WhenPageNumberIsNegative()
    {
        // Arrange
